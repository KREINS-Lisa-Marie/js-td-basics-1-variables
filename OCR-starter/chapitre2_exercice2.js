...
console.log("Il fait "+celsius+" degrés Celsius, ce qui équivaut à "+ fahrenheit + " degrés Fahrenheit.");
...
console.log("Il fait "+celsius+" degrés Celsius, ce qui équivaut à "+ ((celsius * 9/5) + 32) + " degrés Fahrenheit.");